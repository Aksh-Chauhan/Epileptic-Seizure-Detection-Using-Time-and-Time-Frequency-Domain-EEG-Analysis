...
def load_data(base_path):
    data = []
    labels = []
    label_mapping = {'Z': 0, 'O': 1, 'N': 2, 'F': 3, 'S': 4}  # Define label mapping for Case 2
...
def create_model(input_shape_time, input_shape_tf):
    ...
    output = Dense(5, activation='softmax')(dense1)  # Adjust output layer for 5-class classification
